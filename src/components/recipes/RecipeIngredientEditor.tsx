        ...
        <div className="rounded-[var(--radius-md)] border border-[var(--border-default)] overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-[var(--bg-muted)]">
              <tr>
                <th className="px-2 sm:px-4 py-2.5 text-left font-semibold text-[var(--text-secondary)]">
                  Ingrediente
                </th>
                <th className="px-2 sm:px-4 py-2.5 text-left font-semibold text-[var(--text-secondary)]">
                  Cantidad
                </th>
                <th className="px-2 sm:px-4 py-2.5 text-left font-semibold text-[var(--text-secondary)] hidden md:table-cell">
                  Stock disp.
                </th>
                <th className="px-2 sm:px-4 py-2.5 text-right font-semibold text-[var(--text-secondary)]">
                  Costo
                </th>
                <th className="px-2 sm:px-4 py-2.5 text-left font-semibold text-[var(--text-secondary)] hidden lg:table-cell">
                  Notas
                </th>
                <th className="w-10" />
              </tr>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 sm:px-4 py-3">
                      <div className="font-semibold text-[var(--text-heading)] leading-tight">
                        {ing.name}
                      </div>
                    ...
                    <td className="px-2 sm:px-4 py-3">
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        <input
                          ...
                          className="w-16 sm:w-24 px-1.5 sm:px-2 py-1.5 border border-[var(--border-default)] rounded-[var(--radius-sm)] text-sm text-[var(--text-heading)] focus:outline-none focus:ring-3 focus:ring-[var(--red-100)] focus:border-[var(--red-600)]"
                        />
            ...
            <tfoot className="bg-[var(--bg-muted)] border-t border-[var(--border-default)]">
              <tr>
                <td
                  colSpan={2}
                  className="px-2 sm:px-4 py-2.5 font-semibold text-[var(--text-secondary)] md:hidden"
                >
                  Total materiales ({value.length})
                </td>
                <td
                  colSpan={3}
                  className="px-2 sm:px-4 py-2.5 font-semibold text-[var(--text-secondary)] hidden md:table-cell"
                >
                  Total materiales ({value.length} ingrediente
                  {value.length !== 1 ? "s" : ""})
                </td>
                <td className="px-2 sm:px-4 py-2.5 text-right font-bold text-[var(--red-600)] font-display text-base">
                  {formatUSD(totalCost)}
                </td>
