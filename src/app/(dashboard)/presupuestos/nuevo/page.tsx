...
import { convertToBs, formatUSD, formatBs } from "@/lib/currency";
...
export default function NuevoPresupuestoPage() {
  ...
  const handleCalculatorChange = (breakdown: PriceBreakdown) => {
    setPriceBreakdown(breakdown);
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <div className="p-4">
              {loadingIngs ? (
                <div className="text-center py-6 text-[#A07050]">Cargando insumos...</div>
              ) : (
                <QuoteBuilder
                  value={sections}
          ...
          <Card>
            ...
            <div className="p-4">
              <textarea
                placeholder="Ingresa notas o condiciones especiales del presupuesto (ej. condiciones de pago, tiempo de entrega, etc.)"
                rows={3}
                {...register("notes")}
        ...
        <div className="space-y-6">
          <Card className="sticky top-6">
            ...
            <div className="p-4">
              {loadingRate ? (
                <div className="text-center py-4 text-[#A07050]">Cargando tasa...</div>
              ) : (
                <PriceCalculator
